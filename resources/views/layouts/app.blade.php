            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        @else
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('actors.index') }}">{{ __('Atores') }}</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('directors.index') }}">{{ __('Diretores') }}</a>
                            </li>
                            <li class="nav-item">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('customers.index') }}">{{ __('Clientes') }}</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('rents.index') }}">{{ __('Alugueis') }}</a>
                            </li>
